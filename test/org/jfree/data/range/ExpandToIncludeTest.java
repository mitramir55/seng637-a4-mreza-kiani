...
public class ExpandToIncludeTest {
    ...
    @Test
    public void valueWithTheSameLowerBound() {
        Range r1 = new Range(0.5, 1);

        Range result = Range.expandToInclude(r1, 0.5);
        Range expected = new Range(0.5, 1);
        assertEquals(result, expected);
    }

    @Test
    public void valueWithTheSameUpperBound() {
        Range r1 = new Range(0.5, 1);
